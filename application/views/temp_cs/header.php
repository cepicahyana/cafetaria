        ...
        <?php } ?>
					<div class="container">
						<div class="main-header-left ">
							...
							<i class="fas fa-comment-dots sadow" style="font-size:25px;color:#FFFF00"></i> KONEK WA </div>
								<img src="<?php echo base_url()?>assets/img/brand/logo.png" class="logo-default">
								<div class="icon-white" style="color:white;margin-top:20px;font-size:16px;font-weight:bold"> KONEK WA </div>
						...
						<div class="main-header-right">
								...
								<div class="dropdown main-profile-menu nav nav-item nav-link">
									<a class="profile-user d-flex" href=""><img src="<?php echo base_url()?>file_upload/foto/<?php echo $foto?>" 
                                    alt="user-img" class="rounded-circle mCS_img_loaded"><span></span></a>
									<div class="dropdown-menu">
										<div class="main-header-profile header-img">
											<div class="main-img-user"><img alt="" src="<?php echo base_url()?>file_upload/foto/<?php echo $foto?>""></div>
