...
<!DOCTYPE html>
<html lang="en">
	<?php echo $this->load->view("temp_master/head");?>
	<body class="main-body  app">
		...
		<div class="page">
		   ...
		   <!-- main-header opened -->
		<?php echo $this->load->view("temp_master/header");?>
		  <!-- main-header closed -->

			<!--Horizontal-main -->
            
            <?php echo $this->load->view("temp_master/menu");?>
			<!--Horizontal-main -->
	

			<!-- main-content opened -->
			<?php echo $this->load->view("temp_master/content");?>
				<!-- /container -->
			</div>
			<!-- /main-content -->
        ...
        <?php
        $this->load->view("temp_master/footer");
        ?>
