...
<!DOCTYPE html>
<html lang="en">
	<?php echo $this->load->view("temp_main/head");?>
	<body class="main-body  app">
		...
		<div class="page">
		   ...
		   <!-- main-header opened -->
		<?php echo $this->load->view("temp_main/header");?>
		  <!-- main-header closed -->

			<!--Horizontal-main -->
            
            <?php echo $this->load->view("temp_main/menu");?>
			<!--Horizontal-main -->
	

			<!-- main-content opened -->
			<?php echo $this->load->view("temp_main/content");?>
				<!-- /container -->
			</div>
			<!-- /main-content -->
