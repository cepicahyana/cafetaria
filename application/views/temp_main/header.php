								...
								<ul class="header-megamenu-dropdown  nav">
									<li class="nav-item">
										<div class="btn-group dropdown">
											<button aria-expanded="false" aria-haspopup="true" class="btn btn-link dropdown-toggle" data-toggle="dropdown" id="dropdownMenuButton2" type="button"><span><i class="fa fa-chart-pie"></i> Report </span></button>
													...
													<div class="drop-menu-inner">
														<div class="header-content text-left d-flex">
															<div class="text-white">
																...
																<h6 class="menu-header-subtitle mb-0">Reporting</h6>
															</div>
												...
												<div class="setting-scroll">
													<div>
														<div class="setting-menu ">
															<a  class="dropdown-item" href="<?php echo base_url()?>report"><i class="fa fa-chart-pie tx-16 mr-2 mt-1"></i>Grafik</a>
															<a  class="dropdown-item" href="<?php echo base_url()?>report/input"><i class="fa fa-edit tx-16 mr-2 mt-1"></i>Input data</a>
