...
class m_konfig extends CI_Model  {
	...
	function templateEmailConfirm($isi,$qr_utama=null,$nama='KONFIRMASI KEHADIRAN')
	{
	    $base_url=$this->m_reff->pengaturan(1); 
	    if($qr_utama){
	        $button='<center>
 <a href="'.$base_url.'/confirm?id='.$qr_utama.'" style="-webkit-text-size-adjust: none; text-decoration: none; display: inline-block; color: #FFFFFF; background-color:  #4680ff; border-radius: 4px; -webkit-border-radius: 4px; -moz-border-radius: 4px; width: auto; width: auto; border-top: 0px solid #BACBB1; border-right: 0px solid #BACBB1; border-bottom: 0px solid #BACBB1; border-left: 0px solid #BACBB1; padding-top: 5px; padding-bottom: 5px; font-family: Source Sans Pro, Tahoma, Verdana, Segoe, sans-serif; text-align: center; mso-border-alt: none; word-break: keep-all;" target="_blank"><span style="padding-left:15px;padding-right:15px;font-size:16px;display:inline-block;"><span style="font-size: 12px; line-height: 2; word-break: break-word; mso-line-height-alt: 24px;"><span data-mce-style="font-size: 16px; line-height: 32px;" 
 style="font-size: 16px; line-height: 32px;">'.$nama.'  </span></span></span></a>
 </center>';
	    }
	      $button="";
...
<!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr style="line-height:0px"><td style="padding-right: 0px;padding-left: 0px;" align="center"><![endif]--><img align="center" alt="Image" border="0" class="center fullwidth" 
src="'.$this->konversi->img(realpath('plug/img/borderup.png')).'" style="text-decoration: none; -ms-interpolation-mode: bicubic; border: 0; height: auto; width: 100%; max-width: 500px; display: block;" title="Image" width="500"/>
...
<img align="center" alt="Image" border="0" class="center" src="'.$this->konversi->img(realpath('plug/img/istana1.png')).'" 
style="text-decoration: none; -ms-interpolation-mode: bicubic; border: 0; height: auto; width: 100%; 
...
<table align="center" border="0" cellpadding="0" cellspacing="0" class="divider_content" role="presentation" style="table-layout: fixed; vertical-align: top; border-spacing: 0; border-collapse: collapse; mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-top: 6px dotted #E6E6E6; width: 35%;" valign="top" width="35%">
<tbody>
<tr style="vertical-align: top;" valign="top">
<td style="word-break: break-word; vertical-align: top; -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%;" valign="top"><span></span></td>
</tr>
...
<div style="font-size: 12px; line-height: 1.5; color: #67CCDE; font-family: Lato, Tahoma, Verdana, Segoe, sans-serif; mso-line-height-alt: 18px;">
 ...
 <br>
 <p style="font-size: 11px; line-height: 1.5; text-align: center; word-break: break-word; mso-line-height-alt: 17px; margin: 0;"><span style="font-size: 11px;"><span rel="noopener noreferrer" style="  color: #67CCDE;" target="_blank"><span style="font-size: 11px;"> 
 '.$this->m_reff->pengaturan(7).'</span></span></span><br/></p>
</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
<!--[if (!mso)&(!IE)]><!-->
...
Peserta Rapat Koordinasi <br> 
<span class="mono1" style="font-size:25px"> {nama}<br>
{jabatan}<br></span>
 
 <div align="center" class="img-container center">
<img align="center" alt="Image" border="0" class="center" src="'.$this->konversi->img(realpath('plug/img/divider.png')).'" 
style="text-decoration: none; -ms-interpolation-mode: bicubic; border: 0; height: auto; width: 100%;
 max-width: 318px; display: block;padding:10px" title="Image" width="318"/>
</div>
<b style="font-size:15px;font-family: Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif; mso-line-height-alt: 25px">
{agenda}</b>
<p style="width:70%;font-size:16px"> 
  {tgl}<br>
Pukul {jam} WIB<br>
{tempat} <br>
</p>

<img width="100px" src="{link}">
</p>
</div>
 <center>
...
<!--<![endif]-->
<!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 10px; font-family: Tahoma, Verdana, sans-serif"><![endif]-->
<div style="color:#67CCDE;font-family:Montserrat, Tahoma, Verdana, Segoe, sans-serif;line-height:1.5;padding-top:10px;padding-right:10px;padding-bottom:10px;padding-left:10px;">
<div style="font-size: 12px; line-height: 1.5; color: #67CCDE; font-family: Montserrat, Tahoma, Verdana, Segoe, sans-serif; mso-line-height-alt: 18px;">
 ...
 Protokol Kepresidenan.</span></span></span><br/></p>
</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
<!--[if (!mso)&(!IE)]><!-->
