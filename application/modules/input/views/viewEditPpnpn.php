...
$data	= $this->db->get("data_test_ppnpn")->row();
...
<form  action="javascript:submitForm('modal')" id="modal" url="<?php echo base_url()?>input/update_ppnpn"  method="post" enctype="multipart/form-data">
...
<div class="row row-xs align-items-center mg-b-20">
   ...
   <button  onclick="submitForm('modal')"  
                                    class="float-right btn btn-primary pd-x-30 mg-r-5 mg-t-5"><i class='fa fa-save'></i> Simpan & setujui</button>
...
<script>
	...
	function getData(){
		...
		var url   = "<?php echo site_url("input/getDataPpnpnEdit");?>";
