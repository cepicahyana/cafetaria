					...
					<div class="breadcrumb-header justify-content-between">
						<div>
							<h4 class="content-title mb-2">KELUARGA PEGAWAI</h4>
  ...
  var  dataTable = $('#table').DataTable({ 
	  ...
	  dom: 'Blfrtip',
        ...
        "ajax": {
            "url": "<?php echo site_url('input/getDataFamily');?>",
            "type": "POST",
			"data": function ( data ) {
	...
	function add(){	  
			  var url   = "<?php echo site_url("input/viewAddFamily");?>";
	...
	function edit(id){
					 	    var url   = "<?php echo site_url("input/viewEditFamily");?>";
	...
	function hapus(id,nip,akun,kode){
		  ...
		  swal({
							...
							var url   = "<?php echo site_url("input/hapus_family");?>";
