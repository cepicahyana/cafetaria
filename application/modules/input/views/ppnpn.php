					...
					<div class="breadcrumb-header justify-content-between">
						<div>
							<h4 class="content-title mb-2">PPNPM </h4>
							<nav aria-label="breadcrumb">
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="#">Input data PPNPN yang akan ditest.</a></li>
  ...
  var  dataTable = $('#table').DataTable({ 
	  ...
	  dom: 'Blfrtip',
        ...
        "ajax": {
            "url": "<?php echo site_url('input/getDataPpnpn');?>",
            "type": "POST",
			"data": function ( data ) {
	...
	function add(){	  
			  var url   = "<?php echo site_url("input/viewAddPpnpn");?>";
	...
	function edit(id){
					 	    var url   = "<?php echo site_url("input/viewEditPpnpn");?>";
	...
	function hapus(id,nik,akun,kode){
		  ...
		  swal({
							...
							var url   = "<?php echo site_url("input/hapus_ppnpn");?>";
							var param = {kode:kode,id:id,nik:nik,<?php echo $this->m_reff->tokenName()?>:token};
							$.ajax({
									type: "POST",dataType: "json",data: param, url: url,
									success: function(val){
										token=val['token'];
