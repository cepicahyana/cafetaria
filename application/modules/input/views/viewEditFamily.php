...
<form  action="javascript:submitForm('modal')" id="modal" url="<?php echo base_url()?>input/update_family"  method="post" enctype="multipart/form-data">
...
<script>
	...
	function getData(){
		...
		var url   = "<?php echo site_url("input/getDataKeluargaEdit");?>";
