...
<div class="modal-content">  
	...
	<div class="modal-body" >
		...
		<form  action="javascript:submitForm('modal_tambah')" id="modal_tambah" url="<?php echo base_url()?>autoreplay/insert_list"  method="post" enctype="multipart/form-data">
				...
				<div class="row row-xs align-items-center mg-b-20">
				 ...
				 <div class="row row-xs align-items-center mg-b-20">
					...
					<div class="col-md-12 mb-2 row">
					    <div class="col-md-2">Pilihan ke 1 :</div>
					...
					<div class="col-md-12  mb-2 row">
					    <div class="col-md-2">Pilihan ke 2 :</div>
					    <div class="col-md-4"><input type="text" name="opsi[]" class="form-control"></div>
					    <div class="col-md-2">Deskripsi :</div>
					    <div class="col-md-4"><input class="form-control" type="text" name="desc[]"> </div>
					...
					<div class="col-md-12   mb-2 row">
					    <div class="col-md-2">Pilihan ke 3 :</div>
					    <div class="col-md-4"><input type="text" name="opsi[]" class="form-control"></div>
					    <div class="col-md-2">Deskripsi :</div>
					    <div class="col-md-4"><input class="form-control" type="text" name="desc[]"> </div>
					...
					<div class="col-md-12   mb-2 row">
					    <div class="col-md-2">Pilihan ke 4 :</div>
					    <div class="col-md-4"><input type="text" name="opsi[]" class="form-control"></div>
					    <div class="col-md-2">Deskripsi :</div>
					    <div class="col-md-4"><input class="form-control" type="text" name="desc[]"> </div>
					...
					<div class="col-md-12   mb-2 row">
					    <div class="col-md-2">Pilihan ke 5 :</div>
					    <div class="col-md-4"><input type="text" name="opsi[]" class="form-control"></div>
					    <div class="col-md-2">Deskripsi :</div>
					    <div class="col-md-4"><input class="form-control" type="text" name="desc[]"> </div>
					...
					<div class="col-md-12   mb-2 row">
					    <div class="col-md-2">Pilihan ke 6 :</div>
					    <div class="col-md-4"><input type="text" name="opsi[]" class="form-control"></div>
					    <div class="col-md-2">Deskripsi :</div>
					    <div class="col-md-4"><input class="form-control" type="text" name="desc[]"> </div>
					...
					<div class="col-md-12   mb-2 row">
					    <div class="col-md-2">Pilihan ke 7 :</div>
					    <div class="col-md-4"><input type="text" name="opsi[]" class="form-control"></div>
					    <div class="col-md-2">Deskripsi :</div>
					    <div class="col-md-4"><input class="form-control" type="text" name="desc[]"> </div>
					...
					<div class="col-md-12   mb-2 row">
					    <div class="col-md-2">Pilihan ke 8 :</div>
					    <div class="col-md-4"><input type="text" name="opsi[]" class="form-control"></div>
					    <div class="col-md-2">Deskripsi :</div>
					    <div class="col-md-4"><input class="form-control" type="text" name="desc[]"> </div>
					...
					<div class="col-md-12   mb-2 row">
					    <div class="col-md-2">Pilihan ke 9 :</div>
					    <div class="col-md-4"><input type="text" name="opsi[]" class="form-control"></div>
					    <div class="col-md-2">Deskripsi :</div>
					    <div class="col-md-4"><input class="form-control" type="text" name="desc[]"> </div>
					...
					<div class="col-md-12   mb-2 row">
					    <div class="col-md-2">Pilihan ke 10 :</div>
					    <div class="col-md-4"><input type="text" name="opsi[]" class="form-control"></div>
					    <div class="col-md-2">Deskripsi :</div>
					    <div class="col-md-4"><input class="form-control" type="text" name="desc[]"> </div>
			 	...
			 	<div class="row row-xs align-items-center ">
					...
					<div class="col-md-8 mg-t-5 mb-2">
