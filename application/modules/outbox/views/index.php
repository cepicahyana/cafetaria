...
<!-- breadcrumb -->
	<div class="breadcrumb-header justify-content-between">
						<div>
							<h4 class="content-title mb-2"><i class="fa fa-envelope-open"></i> Outbox</h4>
							<nav aria-label="breadcrumb">
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="#">Data pesan keluar</a></li>
											...
											<table id="table" class="table mg-b-0 text-md-nowrap ">
												<thead>
													<tr>
														...
														<th  width="120px"  class="text-primary"><i class="fa fa-clock"></i>  Waktu Kirim</th>
														<th width="120" class="text-primary"><i class="fa fa-phone"></i>  Nomor Tujuan</th>
														<th class="text-primary"><i class="fa fa-comment"></i> Pesan Keluar</th> 
														<th width="70px" class="text-primary"><i class="fa fa-clock"></i>  Status</th>
														 <th width="90px"> </th> 
...
<script type="text/javascript">
  ...
  var  dataTable = $('#table').DataTable({ 
	  ...
	  dom: 'Blfrtip',
        ...
        "ajax": {
            "url": "<?php echo site_url('outbox/getData');?>",
            "type": "POST",
			"data": function ( data ) {
