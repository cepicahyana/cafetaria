                                ...
                                <center class="hide">
                                    <label>
                                        <div style="max-width:300px">
                                            <b>	PHOTO PROFILE</b>
                                            <br>
                                            <img class="img-responsive" style="width:200px;height:200px;border-radius:20px;border:#F5F5DC solid 2px;padding:5px;margin-top:20px;margin-bottom:20px;" id="blah"
                                             src="<?php echo base_url()?>plug/img/dp/<?php echo $profileimg;?>" alt="" height="100px" />
