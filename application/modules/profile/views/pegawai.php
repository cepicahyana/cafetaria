    ...
    <div>
        <div  id="area_formSubmit">
            <div class="card">
                ...
                <div class="card-body">
                    <form id="formSubmit" action="javascript:submitForm('formSubmit')" method="post" url="<?php echo site_url('profile/update_pegawai');?>" enctype="multipart/form-data">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group fill">
                                    ...
                                    <input type="text" class="form-control" name="f[no_hp]" value="<?php echo $data->no_hp;?>" required>
                                </div> 
                                <div class="form-group fill">
