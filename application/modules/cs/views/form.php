		...
		<form  action="javascript:submitForm('modal')" id="modal" url="<?php echo site_url($get_controller.$action_url)?>"  method="post" enctype="multipart/form-data">
			...
			<div class="form-group ">
				<div class="row">
					...
					<div class="col-md-9">
						<input name="f[owner]"  type="text" class="form-control" value="<?= set_value('owner', $nama_lengkap);?>" autofocus>
					</div>
				</div>
			</div>
			<div class="form-group ">
				<div class="row">
					...
					<div class="col-md-9">
						<input name="f[nama_cs]"  type="text" class="form-control" value="<?= set_value('nama_cs', $nama_cs);?>">
					</div>
				</div>
			</div>
			<div class="form-group ">
			...
			<div class="form-group ">
				<div class="row">
					...
					<div class="col-md-9">
						<input name="f[telp]" type="text" class="form-control" value="<?= set_value('telp', $telp);?>">
					</div>
				</div>
			</div>
			<div class="form-group ">
