...
?>
		...
		<div>
			<h4 class="content-title mb-2"> DATA PENGADUAN</h4>
		...
		<div class="d-flex my-auto">
			<div class=" d-flex right-page">
				<div>
					<!--<button onclick='addData()' class='btn btn-warning' style="min-width:180px">-->
					<!--	<i class="fa fa-edit"></i> Tambah Akun </button>-->
					<?php
					$data[""] = "--- filter Status ---";
					$data[0] = "Open (Belum ditanggapi)";
					$data[1] = "Close (Sudah selesai)";
					$data[2] = "Hold (Masih pertimbangan)";
					echo form_dropdown("filter",$data,"","class='form-control' onchange='reload_table()'");
					?>
				</div>
			</div>
		</div>
	...
	<div class="main-content-body">
		...
		<script type="text/javascript">
			...
			function addData() {
				var url =
					"<?php echo site_url($get_controller."/form_data");?>";
				var param = {
...
function ceklis()
			...
			function hapus() {
				...
				if(h!="true")
				{
				swal("Silahkan pilih data terlebih dahulu", {
							icon: "warning",
							buttons: {
								confirm: {
                ...
                swal({
					...
					if (willDelete) {
						...
						var url =
							"<?php echo site_url($get_controller."/hapus_data");?>";
						var param = {
							id: checkbox_value,
							<?php echo $this->m_reff->tokenName()?>: token
						};
