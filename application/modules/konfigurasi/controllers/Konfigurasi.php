...
class Konfigurasi extends MY_Controller {
	...
	function backupdb()
	{
	   ...
	   $nama=$db."-"; 
	   $table=array("admin","data_acara","data_file","data_group","data_kontak","data_peserta","data_peserta_scan","file_peserta","main_konfig","main_level","main_log","main_menu","pengaturan","tm_persetujuan","tr_jenis_kegiatan","tr_jenis_undangan","tr_persetujuan","tr_tempat_rakor");
	  ...
	  public function restore()    
    {
       ...
       // $this->load->model('sismas_m');
        ...
        $fotoupload=$file['file_name'];
          ...
          $isi_file = file_get_contents('./files/' . $fotoupload); //PANGGIL FILE YANG TERUPLOAD
	...
	function hapusTahun()
	{
		echo json_encode($this->mdl->hapusTahun());
	}
}